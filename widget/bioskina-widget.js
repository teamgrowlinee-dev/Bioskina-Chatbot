(function () {
  ...
  var config = Object.assign(
    {
      ...
      tooltipTitle: "Tere!",
      tooltipText:
        "Tee juuksetüübi või nahatüübi test või küsi tootesoovitust.",
      welcomeMessage:
      ...
      exampleMessage:
        'Näiteks võid teha "Juuksetüübi testi", "Nahatüübi testi", kirjutada "otsi kuivale nahale seerumit" või küsida "kuidas tagastus käib?"',
  ...
  var header = createElement(
    ...
    '<div class="bio-chatbot__brand">' +
      ...
      '<p class="bio-chatbot__eyebrow">Natural cosmetics · Support</p>' +
      "<h2>" +
